...
# cities = ["Bishkek", "Astana", "Almaty","Moskow","Samara","Cкриптонит","Бакр","Xxxtentacion","Xcho","Jan Khalib","Mersedes-Benz", "BMW","Hyndai", "Tayota","Rols Rois" ]
# print(cities[0:15])
# print(cities[2:7])
...
# цифра 110 встречается в списке 3 раза


# Доп задание:
# 8) Даны два списка, удалите все элементы первого списка из второго, то есть
# дубликаты.
...
# экран весь плейлист
# music = ["Положение","Riptide","Belyache","Jocelyn flores","Танцуй сама","Цепи","So low","Hex","Revenge","Again"]
